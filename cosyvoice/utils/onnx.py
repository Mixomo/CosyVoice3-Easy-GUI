...
class SpeechTokenExtractor():
    def __init__(self, model_path):
        ...
        providers = onnx_providers(prefer_cuda=True, device_id=self.local_rank)
        self.speech_tokenizer_session = onnxruntime.InferenceSession(model_path, sess_options=option, providers=providers)
...
class EmbeddingExtractor():
    def __init__(self, model_path):
        ...
        self.campplus_session = onnxruntime.InferenceSession(model_path, sess_options=option, providers=providers)
